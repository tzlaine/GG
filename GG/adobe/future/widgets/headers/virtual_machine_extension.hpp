...
public:
    ...
    typedef boost::function<const adam_function& (name_t)>       adam_function_lookup_t;
    ...
    typedef closed_hash_map<name_t, adam_function>         adam_function_map_t;
    ...
    const adam_function& adamproc(name_t name) const;

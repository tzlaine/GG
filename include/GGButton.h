...
protected:
    /** \name Accessors */ //@{
    const vector<StateButton*>&               Buttons() const;     ///< returns the state buttons in the group
    const vector<boost::signals::connection>& Connections() const; ///< returns the connections to the state buttons
    //@}

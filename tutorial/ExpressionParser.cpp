...
expression_parser_rules::expression_parser_rules(const lexer& tok, const name_rule& keyword_) :
    keyword(keyword_)
{
...
#undef NAME
    ...
    qi::on_error<qi::fail>(expression, detail::report_error(_1, _2, _3, _4));
}
